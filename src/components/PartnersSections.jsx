    ...
    return (
        <section className="relative w-full bg-black text-white py-20 flex flex-col mb-20 items-center overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-4">
                <h2 className="text-3xl md:text-5xl font-bold text-gray-200 mb-2">Trusted by these</h2>
                <h3 className="text-3xl md:text-5xl font-bold text-blue-300 mb-8">fine partners</h3>
